...
func AdminRoutes(router fiber.Router, adminSvc services.AdminService, mw *middleware.Middleware) {
	...
	teacherRoutes.Delete("/:teacherID/:subjectID/remove-teacher", admin.RemoveTeacherFromSubject)
	...
	parentRoutes.Delete("/:parentID/:studentID/remove-student", admin.RemoveParentFromStudent)
